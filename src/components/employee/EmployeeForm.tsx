...
export default function EmployeeForm({
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [restaurantId, employeeId, isEditMode, token]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (token) {
      try {
        const isMatriz = formData.unitId === restaurantId;
        ...
        const employeeData = {
          ...
          restaurantUnit: isMatriz ? "" : formData.unitId,
        };
  ...
  return (
    <div className="pt-15 flex min-h-screen flex-col">
      <div className="w-full max-w-4xl space-y-10 rounded-lg bg-white p-8 shadow-md">
        <div className="mb-6 flex flex-row items-start justify-between gap-4 sm:flex-row sm:items-center">
