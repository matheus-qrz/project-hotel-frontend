...
export default function ProductsList({ slug }: ProductsListProps) {
  ...
  const categories = [
    "Todos",
    ...Array.from(
      new Set(products.map((product) => product.category || "Todos")),
    ),
  ];
  ...
  const handleRetry = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Não foi possível recarregar os produtos. Tente fazer login novamente.",
        variant: "destructive",
        duration: 5000,
      });
      await handleLogout();
    ...
    return (
      <Card>
        <CardContent className="p-8 pt-6 text-center">
          ...
          <h3 className="mb-2 text-lg font-medium">Sessão expirada</h3>
    ...
    <div className="w-full space-y-6 p-4">
      <div className="mb-6 flex flex-col gap-4 lg:flex-row">
        <div className="relative flex-1">
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 ${products.length === 0 ? "cursor-not-allowed bg-muted" : ""}`}
              value={searchTerm}
        ...
        <div className="flex gap-2 max-lg:flex-col">
          <div className="flex w-full gap-2">
            ...
            <div className="sm:max-w-auto grid min-w-[140px] flex-1 grid-cols-3 gap-2">
              <Button
                variant="outline"
                size="icon"
                onClick={() =>
          ...
          <div className="flex gap-3 max-lg:flex-col">
            <Button
              onClick={() =>
                router.push(`/admin/restaurant/${slug}/products/add`)
              }
      ...
      {!error && (
        <>
          {isLoadingProducts ? (
            <Card>
              <CardContent className="flex flex-col items-center p-8 pt-6 text-center">
                ...
                <p className="mb-6 max-w-md text-muted-foreground">
                  Este restaurante ainda não possui produtos cadastrados no
                  cardápio.
                </p>
              </CardContent>
            </Card>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                          {categoryProducts.map((product) => (
                            <ProductCard
                              ...
                              onEditClick={() =>
                                router.push(
                                  `/admin/restaurant/${slug}/products/${product._id}/edit`,
                                )
                              }
                              onPromotionClick={() =>
                                router.push(
                                  `/admin/restaurant/${slug}/products/${product._id}/promotion`,
                                )
                              }
                    ...
                    <div className="space-y-3">
                      {sortedProducts.map((product) => (
                        <ProductCard
                          ...
                          onDeleteClick={() =>
                            handleDeleteClick(product as Product)
                          }
                        />
                      ))}
                    </div>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <strong>{currentProduct?.name}</strong>? Esta ação não pode ser
              desfeita.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <Card
      className={`relative min-h-36 w-full ${product.isOnPromotion && promotionActive ? "border-rose-200 bg-rose-50" : ""}`}
    >
        ...
        <div className="flex gap-4">
          <div className="relative h-16 w-16 flex-shrink-0 overflow-hidden rounded-md bg-muted">
            ...
            {product.isOnPromotion && promotionActive && discountPercentage && (
              <div className="absolute right-0 top-0 rounded-bl bg-rose-500 px-1 py-0.5 text-xs font-bold text-white">
                -{discountPercentage}%
              </div>
            )}
          </div>
          ...
          <div className="flex flex-1 flex-col">
            <div className="flex items-start justify-between">
                ...
                <DropdownMenu>
                  ...
                  >
                    <DropdownMenuItem asChild>
                      <Link
                        href={`/admin/restaurant/${restaurantId}/products/${product._id}/details`}
                      >
              ...
              <div className="absolute right-4 top-2 hidden flex-col gap-2 max-lg:flex">
                <Button
                  variant="outline"
                  size="sm"
                  className="h-8 px-2"
            ...
            <div className="absolute bottom-4 left-4 mt-4 flex gap-2 lg:static">
