  ...
  if (error) {
    return (
      <div className="flex h-screen flex-col p-4">
        ...
        <div className="flex items-start rounded-md bg-red-100 p-4 text-red-600">
          <AlertCircle
    ...
    return (
      <div className="flex h-screen flex-col p-4">
        ...
        <p className="text-gray-600">
          O produto solicitado não foi encontrado. Verifique se o ID está
          correto ou retorne à lista de produtos.
        </p>
        <button
          onClick={() =>
            router.push(`/admin/restaurant/${restaurantId}/products`)
          }
          className="mt-4 self-start rounded-md bg-blue-600 px-4 py-2 text-white"
        >
          Voltar à Lista
        </button>
      </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="space-y-4">
                  ...
                  <div className="mb-6 flex items-center justify-between">
                    <div className="flex gap-2">
                      ...
                      <Button
                        onClick={() =>
                          router.push(
                            `/admin/restaurant/${restaurantId}/products/${productId}/edit`,
                          )
                        }
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="min-h-[100px] rounded-lg bg-gray-50 p-3 text-gray-700">
