...
export default function ProductForm({ slug }: ProductFormProps) {
  ...
  const { fields: accompanimentFields, append: appendAccompaniment } =
    useFieldArray({
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      const formattedData: any = {
        ...
        discountPercentage: values.isOnPromotion
          ? Number(values.discountPercentage)
          : null,
        promotionalPrice: values.isOnPromotion
          ? Number(values.promotionalPrice)
          : null,
        promotionStartDate:
          values.isOnPromotion && values.promotionStartDate
            ? values.promotionStartDate
            : null,
        promotionEndDate:
          values.isOnPromotion && values.promotionEndDate
        ...
        <CardContent className="pt-6">
          <Form {...form}>
            ...
            >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Selecione uma imagem do seu dispositivo (recomendado:
                        500x500px)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
              ...
              {isOnPromotion && (
                <div className="bg-muted/20 mt-4 space-y-6 rounded-lg border p-4">
              ...
              {addons && (
                <div className="bg-muted/20 mt-4 space-y-6 rounded-lg border p-4">
                  ...
                  <Separator />
                  {products.filter((p) => p.category === "addOns").length >
                  0 ? (
                    products
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <div className="flex items-center space-x-4">
                                  ...
                                  />
                                  <div className="flex w-full flex-row items-center justify-between rounded-lg border border-gray-300 p-2">
              ...
              {selectedAccompaniments && (
                <div className="bg-muted/20 mt-4 space-y-6 rounded-lg border p-4">
                  ...
                  <Button
                    ...
                    variant="outline"
                    onClick={() =>
                      appendAccompaniment({ name: "", id: crypto.randomUUID() })
                    }
                  >
